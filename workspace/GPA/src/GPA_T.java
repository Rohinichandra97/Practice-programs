...
public class GPA_T {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("The Maximum GPA Calculated till now is :" + GPA_Max);
	    System.out.println("The Minimum GPA Calculated till now is :" + GPA_Min);
	    GPA_Sum +=Accu_GPA; 
	    GPA_Avg = GPA_Sum / (t+1);
	    System.out.println("The Average GPA Calculated till now is :" + GPA_Avg);
    }
