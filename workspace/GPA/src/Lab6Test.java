 ...
 */
public class Lab6Test extends Frame implements ActionListener {
  ...
  public Lab6Test(String filename) {
    this(null, filename);
  }
   ...
   */
  public Lab6Test(String directory, String filename) {
  ...
  static public void main(String[] args) throws IOException {
    ...
    Frame f = new Lab6Test((args.length == 1) ? args[0] : null);
